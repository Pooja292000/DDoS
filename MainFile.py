...
result_knn=metrics.accuracy_score(y_test,knn_prediction)*100
print()
print("------Classification Report------")
print(metrics.classification_report(y_test, knn_prediction))
print("------Accuracy------")
print("Accuracy of K-Nearest Neighbour:",result_knn,'%')
print()
...
vals=[result_mlp,result_knn,result_rf,result_adaboost,result_RNN]
inds=range(len(vals))
labels=["MLP","KNN","RF","Adaboost","RNN"]
fig,ax = plt.subplots()
